...
describe('Sidebar', () => {
  ...
  it('shows PropertiesPanel when a room is selected', () => {
    const room = { id: 'r1', shape: 'rect' as const, x: 0, y: 0, width: 100, height: 80, fill: '#333' }
    renderWithContext(<Sidebar selected={{ type: 'room', id: 'r1' }} />, {
