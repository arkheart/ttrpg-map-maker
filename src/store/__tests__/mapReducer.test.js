...
const rectRoom = { id: 'r1', shape: 'rect', x: 10, y: 20, width: 100, height: 80, fill: '#333' };
const cave = { id: 'c1', points: [0, 0, 10, 10, 20, 0], fill: '#444' };
const terrain = { id: 't1', shape: 'rect', x: 0, y: 0, width: 50, height: 50, terrainType: 'forest' };
const item = { id: 'i1', x: 5, y: 5, symbol: '🚪' };
...
describe('mapReducer — LOAD_STATE', () => {
    it('replaces state entirely', () => {
        const base = mapReducer(emptyState, { type: 'ADD_ROOM', payload: rectRoom });
        const newState = { ...emptyState, items: [item], layerOrder: ['i1'] };
